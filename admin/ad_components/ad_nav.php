          ...
          <?php if ($login) { ?>
               ...
               <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end mt-2 p-0">
                         <li>
                              <p class="m-1 px-3 py-1 text-center fs-5"><?php echo $_SESSION["user_fname"]; ?></p>
                         </li>
                         <hr class="hr p-0 m-0" />
                         <li class="position-relative">
                              <p class="my-1 px-5 text-center font-monospace">$<?php echo $_SESSION["user_bal"]; ?></p><a href="../deposit.php" class=" position-absolute top-50 translate-middle" style="right:1%"><i class="h-r-90 fa-solid fa-plus"></i></a>
                         </li>
                         <hr class="hr p-0 m-0" />
                         <li class="position-relative">
